...
export default function Products() {
  ...
  useEffect(() => {
    const title = category 
      ? `${category} - 아슬란 주방용품 | ASRAN`
      : search
      ? `"${search}" 검색 결과 | ASRAN`
      : "모든 제품 - 아슬란 주방용품 | ASRAN";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12" data-testid="error-state">
            <p className="text-lg text-gray-600 mb-4">제품을 불러오는 중 오류가 발생했습니다.</p>
          ...
          <>
            <div className={`grid gap-6 ${viewMode === "grid" ? "md:grid-cols-2 lg:grid-cols-3" : "grid-cols-1"}`} data-testid="products-grid">
