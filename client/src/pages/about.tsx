...
export default function About() {
  useEffect(() => {
    updateSEO({
      title: "브랜드 소개 - 독일 기술력의 아스란 | ASRAN",
      description:
        "독일의 정밀한 기술력과 합리적인 가격의 완벽한 조합. 아스란의 브랜드 스토리와 철학을 만나보세요.",
      keywords: "아스란, ASRAN, 브랜드, 독일 기술력, 주방용품 제조, 품질 관리",
    });
  }, []);
  ...
  return (
    <div className="min-h-screen bg-asran-bg" data-testid="page-about">
      ...
      <section className="relative asran-gradient text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              독일 기술력의 <span className="text-asran-amber">아스란</span>
            </h1>
            <p className="text-xl lg:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              정밀함과 실용성을 추구하는 독일 엔지니어링 철학으로
              <br />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                <p>
                  2010년 독일 뒤셀도르프에서 시작된 아스란(ASRAN)은 "Advanced
                  Steel Rational Application"의 줄임말로, 첨단 스틸 기술의
                  합리적 적용이라는 의미를 담고 있습니다.
                </p>
                <p>
                  독일의 정밀한 제조 기술과 한국인의 요리 문화를 깊이 연구하여,
                  기능성과 디자인을 모두 만족시키는 프리미엄 주방용품을
                  개발해왔습니다.
                </p>
                <p>
                  우리는 단순히 제품을 판매하는 것이 아닌, 요리하는 즐거움과
                  가족과 함께하는 소중한 시간을 만들어가는 파트너가 되고자
                  합니다.
                </p>
              </div>
            </div>
            <div className="relative">
              ...
              <div className="absolute top-4 left-4 bg-white bg-opacity-90 px-4 py-2 rounded-lg">
                <p className="text-sm font-semibold text-asran-gray">
                  Since 2010
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              아스란이 추구하는 4가지 핵심 가치로 최고의 주방용품을 만들어갑니다
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "독일 기술력",
                description:
                  "정밀한 독일 엔지니어링과 최고급 소재로 제작된 프리미엄 품질",
                color: "text-blue-600",
              },
              {
                icon: Heart,
                title: "건강한 요리",
                description:
                  "안전한 소재와 친환경 코팅으로 가족의 건강을 생각하는 제품",
                color: "text-red-600",
              },
              {
                icon: Globe,
                title: "합리적 가격",
                description:
                  "최고의 품질을 합리적인 가격으로 모든 가정에서 만날 수 있도록",
              ...
              >
                <CardContent className="p-8">
                  ...
                  />
                  <h3 className="text-xl font-bold text-asran-gray mb-3">
                    {value.title}
                  </h3>
      ...
      <section className="py-16 lg:py-24" data-testid="manufacturing-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              독일의 엄격한 품질 기준과 첨단 기술로 만들어지는 아스란 제품의
              제조 과정
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "소재 선별",
                description:
                  "독일산 SUS410 스테인리스 스틸을 비롯한 최고급 원자재만을 엄선합니다.",
                features: [
                  "독일산 프리미엄 스틸",
                  "친환경 인증 소재",
                  "내식성 테스트 통과",
              ...
              },
              {
                ...
                title: "정밀 가공",
                description:
                  "독일 최첨단 CNC 장비와 레이저 커팅 기술로 정밀하게 가공합니다.",
              ...
              },
              {
                ...
                title: "표면 처리",
                description:
                  "특수 코팅과 폴리싱 공정을 통해 내구성과 미관을 동시에 확보합니다.",
                features: [
                  "세라믹 논스틱 코팅",
                  "미러 폴리싱",
                  "스크래치 방지",
              ...
              },
              {
                ...
                title: "품질 검사",
                description:
                  "독일 TÜV 인증 기준에 따른 31가지 품질 검사를 실시합니다.",
              ...
              >
                ...
                >
                  <div className="flex items-center mb-4">
                    <span className="text-4xl font-bold text-asran-amber mr-4">
                      {process.step}
                    </span>
                    <h3 className="text-2xl font-bold text-asran-gray">
                      {process.title}
                    </h3>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {process.features.map((feature, idx) => (
                      <Badge
                        key={idx}
                        className="bg-asran-amber/10 text-asran-gray border-asran-amber"
                      >
      ...
      <section
        className="py-16 lg:py-24 bg-gray-50"
        data-testid="quality-standards-section"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-asran-gray mb-6">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              국제 인증과 엄격한 품질 관리로 안전하고 신뢰할 수 있는 제품을
              제공합니다
            </p>
          </div>
            ...
            {[
              ...
              >
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-bold text-asran-gray mb-4">
                    {standard.title}
                  </h3>
